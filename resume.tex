...
%%% Essentials
\name{Daniel C.}{Morgan}
\address{11 Peabody Terrace | 02138 Cambridge, MA}
\mobile{617-331-6223}

\email{Daniel.Morgan@Channing.Harvard.edu}
\homepage{www.DanielCMorgan.com}
\github{dcolinmorgan}
%\linkedin{dcolinmorgan}
%\skype{dcolinmorgan}
%\stackoverflow{SOid}{SOname}
\twitter{@dcolinmorgan}

%%% Optionals
% \position{Biochemistry \& Biophysics{\enskip\cdotp\enskip}Ph.D. Student} 
\position{Systems Biology \& Bioinformatics{\enskip\cdotp\enskip}Ph.D.} 
% Your expertise/fields
% \quote{``live in the world you make."} % A quote or statement
